    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <h4 class="text-white mb-3">Notre Entreprise</h4>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Fes, Morocco</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+212 680651421</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>errazy.abdelfatah@gmail.com</p>
            ...
            <div class="col-lg-4 col-md-6">
                <h4 class="text-white mb-3">Bulletin d'Informations</h4>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">ErrazyScripts</a>, Tous droits réservés.
                </div>
